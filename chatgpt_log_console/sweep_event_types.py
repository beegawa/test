...
후보들 = [
    ...
    "CONTENT_LOG", "USER_CONTENT_LOG", "MESSAGE_CONTENT_LOG", "CHAT_MESSAGE_LOG",
    "CHAT_LOG", "CHATS_LOG", "CHAT", "CONVO_LOG", "TRANSCRIPT_LOG",
    "MESSAGE_LOG", "MESSAGES_LOG", "MESSAGE", "THREAD_LOG", "THREADS_LOG",
    "CHATGPT_LOG", "GPT_LOG", "PROMPT_LOG", "COMPLETION_LOG", "INTERACTION_LOG",
    # 공식 안내에 나오는 나머지 종류
